 ...
 */
public class UpdateAdmin1 extends javax.swing.JFrame {

    /**
     * Creates new form UpdateAdmin1
     */
    public UpdateAdmin1() {
        initComponents();
    }
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            st.executeUpdate("update admintables set ID='"+ID+"', AdminName='"+AdminName+"',contactNo='"+contactNo+"',email='"+email+"',address='"+address+"',AdminPass='"+AdminPass+"',gender='"+gender+"'where ID='"+ID1+"'  ");
            st.executeUpdate("update admintables set ID='"+ID+"', AdminName='"+AdminName+"',contactNo='"+contactNo+"',email='"+email+"',address='"+address+"',AdminPass='"+AdminPass+"',gender='"+gender+"'where AdminName='"+AdminName1+"'  ");
            st.executeUpdate("update admintables set ID='"+ID+"', AdminName='"+AdminName+"',contactNo='"+contactNo+"',email='"+email+"',address='"+address+"',AdminPass='"+AdminPass+"',gender='"+gender+"'where address='"+address1+"'  ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAdmin1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
