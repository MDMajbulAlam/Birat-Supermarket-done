...
public class AdminDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/admin details.png"))); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 460, 370));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
           ...
           try
        {
          Connection con=ConnectionProvider.getCon();
            ...
            ResultSet rs=st.executeQuery("select * from admintables");
    ...
    private void PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrintActionPerformed
        ...
        try
        {
            AdminTable.print(JTable.PrintMode.NORMAL);
        }
        catch(Exception e)
        {
