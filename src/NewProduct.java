...
public class NewProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        partNo.setForeground(new java.awt.Color(153, 153, 153));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Activationcb, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(40, 40, 40)
                        .addComponent(jLabel8))
                    .addComponent(Activationcb, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 710, 470));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
          Connection con=ConnectionProvider.getCon();
            ...
            ResultSet rs=st.executeQuery("select max(SerialNO)from producttable");
            if(rs.first())
            {
                int id=rs.getInt(1);
                id=id+1;
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        // TODO add your handling code here:
        String SerialNO=number.getText();
        String PartNo=partNo.getText();
        String ProductName=Name.getText();
        String rate=Rate.getText();
        String quantity=Quantity.getText();
        String description=Description.getText();
        String Activation=(String)Activationcb.getSelectedItem();
        try{
             Connection con=ConnectionProvider.getCon();
             Statement st=con.createStatement();
             st.executeUpdate("insert into producttable values('"+SerialNO+"','"+PartNo+"','"+ProductName+"','"+rate+"','"+quantity+"','"+description+"','"+Activation+"')");
